...
function FormPerfilAdvogado() 
{
    ...
    function enviarDadosParaAtualizacao() 
    {
        ...
        if (sessionStorage.getItem('tipoUsuario') == "AdvogadoFisico") {
            ...
            api.put(`/advogados-fisicos/${usuario.id}`, usarioParaAtualzar, {
                headers: {
                    Authorization: TOKEN,
                },
            })
            ...
            api.put(`/advogados-juridicos/${usuario.id}`, usarioParaAtualzar, {
                headers: {
                    Authorization: TOKEN,
                },
            })
        ...
        <>
            ...
            <div className="w-full max-w-[75%] mx-auto py-4 mb-10 flex flex-col gap-6 shadow-md rounded-lg bg-white">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                    ...
                    <Input label="OAB:" name="oab" value={usuario.oab} disabled />
