            ...
            <div className="flex flex-col min-h-[60vh] rounded-2xl p-8">
                ...
                <div className="w-full flex flex-col items-center mt-8 gap-4">
                    ...
                    <a
                        ...
                        className="bg-[#25D366] flex items-center gap-2 text-white rounded-lg font-bold text-lg px-8 py-3 shadow-md transition-colors duration-200 hover:bg-[#128C7E] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
